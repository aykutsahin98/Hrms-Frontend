...
export default function EmployerProfileUpdate() {
  ...
  const employerUpdateShema= Yup.object().shape({
    ...
    phoneNumber: Yup.string().required("Bu alan zorunludur").min(10,"Telefon numarası 11 haneli olmalıdır").max(10,"Telefon numarası 11 haneli olmalıdır"),
  ...
  return (
    <div style={{marginTop:120, marginBottom:210, paddingLeft:100, paddingRight:100}}>
